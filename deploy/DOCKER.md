...
docker run -d \
  ...
  ghcr.io/tantaolov/sub2api:latest
```
...
services:
  sub2api:
    image: ghcr.io/tantaolov/sub2api:latest
    ports:
      - "8080:8080"
    environment:
...
- [GitHub Repository](https://github.com/TanTaolov/sub2api)
- [Documentation](https://github.com/TanTaolov/sub2api#readme)
