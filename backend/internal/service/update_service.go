...
// compareVersions compares versions, including the fork's numeric _N revision.
...
func parseVersion(v string) [4]int {
	...
	baseVersion, revision, hasRevision := strings.Cut(v, "_")
