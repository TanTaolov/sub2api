  ...
  <div class="flex flex-col gap-1">
    ...
    <div class="flex items-center gap-1">
      ...
      >
        ...
        <span class="font-mono font-semibold">{{ concurrencyUsed }}</span>
    ...
    <div v-if="sessionsMax > 0" class="flex items-center gap-1">
      ...
      >
        ...
        <span class="font-mono font-semibold">{{ sessionsUsed }}</span>
        <span class="opacity-40">/</span>
    ...
    <div v-if="rpmMax > 0" class="flex items-center gap-1">
      ...
      >
        ...
        <span class="font-mono font-semibold">{{ rpmUsed }}</span>
        <span class="opacity-40">/</span>
