<template>
  ...
  <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
    <!-- Balance -->
    <ElCard shadow="never" v-if="!isSimple" class="element-surface-card p-4">
  ...
  <ElCard shadow="never" v-if="!isSimple && platformCards.length > 0" class="element-surface-card p-4">
