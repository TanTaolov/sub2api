<template>
  ...
  <ElTableColumn :min-width="120" align="left">
    ...
    <template #default="{ row: m }"><div class="py-2 pr-3 font-medium text-gray-900 dark:text-gray-100" >{{ formatMonitorModel(m.model) }}</div></template>
  </ElTableColumn>
  <ElTableColumn :min-width="120" align="left">
    <template #header><div class="py-2 pr-3">{{ t('channelStatus.detailColumns.latestStatus') }}</div></template>
    <template #default="{ row: m }"><div class="py-2 pr-3" ><span
  ...
  <ElTableColumn :min-width="120" align="left">
    ...
    <template #default="{ row: m }"><div class="py-2 pr-3 text-gray-700 dark:text-gray-300" >{{ formatLatency(m.latest_latency_ms) }}</div></template>
  </ElTableColumn>
  <ElTableColumn :min-width="120" align="left">
    <template #header><div class="py-2 pr-3">{{ t('channelStatus.detailColumns.availability7d') }}</div></template>
    <template #default="{ row: m }"><div class="py-2 pr-3 text-gray-700 dark:text-gray-300" >{{ formatPercent(m.availability_7d) }}</div></template>
  </ElTableColumn>
  <ElTableColumn :min-width="120" align="left">
    <template #header><div class="py-2 pr-3">{{ t('channelStatus.detailColumns.availability15d') }}</div></template>
    <template #default="{ row: m }"><div class="py-2 pr-3 text-gray-700 dark:text-gray-300" >{{ formatPercent(m.availability_15d) }}</div></template>
  </ElTableColumn>
  <ElTableColumn :min-width="120" align="left">
    <template #header><div class="py-2 pr-3">{{ t('channelStatus.detailColumns.availability30d') }}</div></template>
    <template #default="{ row: m }"><div class="py-2 pr-3 text-gray-700 dark:text-gray-300" >{{ formatPercent(m.availability_30d) }}</div></template>
  </ElTableColumn>
  <ElTableColumn :min-width="120" align="left">
    <template #header><div class="py-2 pr-3">{{ t('channelStatus.detailColumns.avgLatency7d') }}</div></template>
    <template #default="{ row: m }"><div class="py-2 pr-3 text-gray-700 dark:text-gray-300" >{{ formatLatency(m.avg_latency_7d_ms) }}</div></template>
  </ElTableColumn>
</ElTable>
    </div>
