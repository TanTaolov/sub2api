  ...
  <AppLayout>
    <div class="mx-auto flex max-w-md flex-col items-center space-y-6 py-8">
      ...
      <div v-if="expired" class="text-center">
        ...
        <ElButton type="primary" class="mt-4" @click="router.push('/purchase')">{{ t('payment.result.backToRecharge') }}</ElButton>
      </div>
      ...
      <!-- Cancel button -->
      <ElButton v-if="!expired && orderId" class="w-full" :disabled="cancelling" @click="handleCancel">
