export default {
    accounts: {
      ...
      proxy: 'Proxy',
      noProxy: 'No Proxy',
      proxyPool: 'Proxy Pool (Optional)',
      proxyPoolHint: 'Set concurrency for each proxy. Account concurrency is the sum of all proxies.',
      addProxy: 'Add Proxy',
      selectProxy: 'Select Proxy…',
      proxyConcurrency: 'Concurrency',
      removeProxy: 'Remove Proxy',
      proxyPoolEmpty: 'No proxies added',
      proxyUnavailable: 'Proxy #{id} (Unavailable)',
